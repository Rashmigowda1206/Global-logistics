...
export const ReportCenter: React.FC = () => {
  ...
  const deliverables = [
    {
      id: 'deliv-ppt',
      title: 'Global Logistics Control Tower Presentation',
      type: 'Executive Slide Deck',
      format: 'PPTX (PowerPoint Only)',
      filenameDoc: '/Global_Logistics_Control_Tower_Presentation.pptx',
      filenamePdf: null,
    ...
    {
      id: 'deliv-report',
      title: 'Comprehensive Project Technical Report',
      type: 'Technical Specification',
      format: 'DOCX & PDF',
      filenameDoc: '/Global_Logistics_Control_Tower_Project_Report.docx',
      filenamePdf: '/Global_Logistics_Control_Tower_Project_Report.pdf',
    ...
    },
    {
      ...
      format: 'DOCX & PDF',
      filenameDoc: '/Global_Logistics_Control_Tower_Research_Paper.docx',
      filenamePdf: '/Global_Logistics_Control_Tower_Research_Paper.pdf',
    ...
    },
    {
      ...
      format: 'DOCX & PDF',
      filenameDoc: '/Global_Logistics_Control_Tower_Literature_Review_Paper.docx',
      filenamePdf: '/Global_Logistics_Control_Tower_Literature_Review_Paper.pdf',
